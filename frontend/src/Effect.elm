...
import Api.Data exposing (Role, encodeRole)
...
signIn : { token : String, id : Uuid, role : Role } -> Effect msg
signIn user =
...
saveUser : { token : String, id : Uuid, role : Role } -> Effect msg
saveUser user =
    SendToLocalStorage
        { key = "user"
        , value =
